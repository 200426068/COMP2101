...
myargs=()
#Making variables to distinguish the detail of the information that we input
vebosemode1=0
debugmode2=0
echo "Myarg array contents: $@"
# loop through the command line arguments
#Moving the command line argument to process the following component
while [ $# -gt 0 ]; do
...
#Applying if condition for checking information of the variable
if [ $vebosemode1 = 1 ]; then
...
# Print out the myargs array with a label
if [ $debugmode2 -gt 0 ]; then
  echo "Debug Mode is On with debug level $debugmode2."
else
